...
_$_Credit _$_$_CreditFromJson(Map<String, dynamic> json) {
  return _$_Credit(
    ...
    lineItems: (json['line_items'] as List)
        ?.map((e) => e == null
            ? null
            : CreditLineItem.fromJson(e as Map<String, dynamic>))
        ?.toList(),
...
_$_CreditLineItem _$_$_CreditLineItemFromJson(Map<String, dynamic> json) {
  return _$_CreditLineItem(
    id: json['id'] as String ?? '',
...
Map<String, dynamic> _$_$_CreditLineItemToJson(_$_CreditLineItem instance) =>
    <String, dynamic>{
      'id': instance.id,
...
Map<String, dynamic> _$_$_CreditInvitationToJson(
        _$_CreditInvitation instance) =>
    <String, dynamic>{
      'id': instance.id,
...
Map<String, dynamic> _$_$_CreditListToJson(_$_CreditList instance) =>
    <String, dynamic>{
      'data': instance.data,
    };
...
Map<String, dynamic> _$_$_CreditItemToJson(_$_CreditItem instance) =>
    <String, dynamic>{
      'data': instance.data,
    };
