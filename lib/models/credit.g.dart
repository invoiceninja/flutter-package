...
_$_CreditInvitation _$$_CreditInvitationFromJson(Map<String, dynamic> json) =>
    _$_CreditInvitation(
      id: json['id'] as String? ?? '',
...
Map<String, dynamic> _$$_CreditInvitationToJson(_$_CreditInvitation instance) =>
    <String, dynamic>{
      'id': instance.id,
