...
// ignore: unused_element
  _Quote call(
      ...
      @JsonKey(name: 'line_items')
          List<QuoteLineItem> lineItems = const <QuoteLineItem>[],
...
abstract class $QuoteCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'line_items') List<QuoteLineItem> lineItems,
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      lineItems: lineItems == freezed
          ? _value.lineItems
          : lineItems as List<QuoteLineItem>,
...
class _$_Quote extends _Quote with DiagnosticableTreeMixin {
  _$_Quote(
      ...
      @JsonKey(name: 'line_items') this.lineItems = const <QuoteLineItem>[],
...
QuoteLineItem _$QuoteLineItemFromJson(Map<String, dynamic> json) {
  return _QuoteLineItem.fromJson(json);
}

class _$QuoteLineItemTearOff {
  const _$QuoteLineItemTearOff();
...
// ignore: unused_element
const $QuoteLineItem = _$QuoteLineItemTearOff();

mixin _$QuoteLineItem {
  String get id;
  ...
  Map<String, dynamic> toJson();
  $QuoteLineItemCopyWith<QuoteLineItem> get copyWith;
}

abstract class $QuoteLineItemCopyWith<$Res> {
  factory $QuoteLineItemCopyWith(
          QuoteLineItem value, $Res Function(QuoteLineItem) then) =
      _$QuoteLineItemCopyWithImpl<$Res>;
  $Res call(
      {String id,
      @JsonKey(name: 'product_key') String productKey,
      String notes,
...
class _$QuoteLineItemCopyWithImpl<$Res>
    implements $QuoteLineItemCopyWith<$Res> {
  _$QuoteLineItemCopyWithImpl(this._value, this._then);

  final QuoteLineItem _value;
  // ignore: unused_field
  final $Res Function(QuoteLineItem) _then;
...
abstract class _$QuoteLineItemCopyWith<$Res>
    implements $QuoteLineItemCopyWith<$Res> {
  factory _$QuoteLineItemCopyWith(
          _QuoteLineItem value, $Res Function(_QuoteLineItem) then) =
      __$QuoteLineItemCopyWithImpl<$Res>;
  @override
  $Res call(
      {String id,
      @JsonKey(name: 'product_key') String productKey,
...
class __$QuoteLineItemCopyWithImpl<$Res>
    extends _$QuoteLineItemCopyWithImpl<$Res>
    implements _$QuoteLineItemCopyWith<$Res> {
  __$QuoteLineItemCopyWithImpl(
      _QuoteLineItem _value, $Res Function(_QuoteLineItem) _then)
      : super(_value, (v) => _then(v as _QuoteLineItem));

  @override
  _QuoteLineItem get _value => super._value as _QuoteLineItem;
...
@JsonSerializable(explicitToJson: true)
class _$_QuoteLineItem with DiagnosticableTreeMixin implements _QuoteLineItem {
  _$_QuoteLineItem(
      {this.id = '',
  ...
  factory _$_QuoteLineItem.fromJson(Map<String, dynamic> json) =>
      _$_$_QuoteLineItemFromJson(json);
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'QuoteLineItem(id: $id, productKey: $productKey, notes: $notes, cost: $cost, quantity: $quantity, taxName1: $taxName1, taxRate1: $taxRate1, taxName2: $taxName2, taxRate2: $taxRate2, taxName3: $taxName3, taxRate3: $taxRate3, typeId: $typeId, customValue1: $customValue1, customValue2: $customValue2, customValue3: $customValue3, customValue4: $customValue4, discount: $discount)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'QuoteLineItem'))
      ..add(DiagnosticsProperty('id', id))
  ...
  @override
  _$QuoteLineItemCopyWith<_QuoteLineItem> get copyWith =>
      __$QuoteLineItemCopyWithImpl<_QuoteLineItem>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$_$_QuoteLineItemToJson(this);
  }
}

abstract class _QuoteLineItem implements QuoteLineItem {
  factory _QuoteLineItem(
      {String id,
      @JsonKey(name: 'product_key') String productKey,
      String notes,
      double cost,
      ...
      @JsonKey(name: 'custom_value3') String customValue3,
      @JsonKey(name: 'custom_value4') String customValue4,
      double discount}) = _$_QuoteLineItem;

  factory _QuoteLineItem.fromJson(Map<String, dynamic> json) =
      _$_QuoteLineItem.fromJson;
